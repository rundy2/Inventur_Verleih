...
Anja Claus <anja.claus@htw-dresden.de>; Felix Helmert <felix.helmert@htw-dresden.de>; Dominique Linzmajer <dominique.linzmajer@htw-dresden.de>; Moritz Lehmann <moritz.lehmann@htw-dresden.de>; Silko Grellmann <silko.grellmann@htw-dresden.de>; Fabian Krähmer <fabian.kraehmer@htw-dresden.de>
{localdatetime}
