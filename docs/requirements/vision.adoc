...
Dieses Visions-Dokument bezieht sich auf das Digitale Inventur und Verleih System, das von Team I6 entwickelt wird. Das System wird es der HTW Arbeitsgruppe für Smart Production Systems erlauben, <Hauptfunktionen> zu nutzen, um damit <Vorteile> zu erreichen / <Aufgabe> zu erleichtern / <Problem> zu lösen.
...
| Anwender (User)
| Jeder Mitarbeiter der Gegenstände leiht
