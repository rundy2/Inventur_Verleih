...
. Der Benutzer soll eine Endgeräteunabhängige Website zur Verfügung gestellt bekommen

. Die Website sollte sich möglichst selbst an die Verhältnisse und Bedingungen (Auflösung, Datenverbrauch) des Endgerätes anpassen.

. Der Benutzer bekommt ein Login zugewiesen.
