...
| keine schnelle, einheitliche Übersicht über alle Gegenstände vorhanden
| hoch
| strukturierte Anzeige mit Lagerplatz/Status aller Gegenstände
| xx

| digitales hinzufügen von Gegenständen ins Inventar nicht möglich (neue Gegenstände gehen in der Menge unter)
| hoch
...
| Ausleihen von Gegenständen nur über Papierform machbar/festhaltbar
| hoch
| digitales Ausleihen der Gegenstände über suchen und Status ändern
| xx

| Rückgabe von ausgeliehenen Gegenständen nur über Papierform machbar/festhaltbar
| mittel
| digitale Rückgabe der ausgeliehenen Gegenstände über Eingabe der ID -> Anzeige Lagerort, Status ändern 
| xx

| Falls Inventurzettel oder Ausleihzettel verloren gehen, besteht keine Chance auf Wiedererlangung
| niedrig
