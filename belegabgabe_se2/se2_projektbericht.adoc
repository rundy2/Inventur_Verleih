...
=== Ablauf der Kommunikation unter Verwendung von Tools [SG]
...
Wir versuchten auch GitHub so gut wie möglich zu nutzen, dabei half es uns es insgesamt in drei Branches zu teilen: Main, Development und Backup, damit ein Datenverlust auf jeden Fall vermieden wird. 
...
*Bewertungsstand im Essence Navigator*

image::../belegabgabe_se2/images/Essence1.png[]
...
. Kundenkontakt
. Bewertung im Essence Navigator
...
image::../belegabgabe_se2/images/Essence2.png[]

==== Entwicklung stockt - Meeting mit Prof. Dr. Anke und Coach Robert Ringel 
...
image::../belegabgabe_se2/images/Essence3.png[]
...
. Use-Cases implementieren (ähnliche zusammen packen)
.. UC05/07 
.. UC01/02
.. UC03/04
.. UC06
...
image::../belegabgabe_se2/images/Essence4.png[]
...
image::../belegabgabe_se2/images/Essence5.png[]
...
*Bewertungsstand des Essence Navigators am Ende des Projektes*

Nach der letzten Iteration wurden die Dokumente nochmals gepflegt (ab 24.06.2022), weswegen der Essence Navigator erweitert werden musste.

image::../belegabgabe_se2/images/Essence6.png[]
...
Außerdem hat uns die Unzuverlässigkeiten bei manchen Gruppenmitgliedern unnötig Zeit im Projekt gekostet, dies hätte man durch bessere Kommunikation und Teilnahme an den Meetings verhindern können. Am Anfang war dies aber noch durch Selbstüberschätzung nicht ersichtlich. Dadurch war die Lastverteilung am Ende ungleich und somit gab es einzelne Inselkonstrukte, die einfach überfordert wurden. Das Backend wurde im Alleingang entwickelt, die Meetings fanden teilweise nur zu dritt statt. Die Dokumentation 
