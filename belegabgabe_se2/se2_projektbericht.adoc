...
Wir haben versucht, die Planung der einzelnen Teilaspekte so zu gestalten, dass die eben genannten Eigenschaften stets in hohem Ausmaß vorhanden sind. Leider ist dies gerade zum Anfang des Semster schwer gewesen, weil unsere beiden Softwarearchitekten nur schwierig zu erreichen waren. Das Projektmanagement probierte mehrere Methoden aus den Vorlesungen, doch scheiterte meist an der fehlenden Kommunikationsart. 
