...
== Inventur Verleih - Digitale Inventur- und Verleihliste (I6)
Dies ist der Projekt Bericht des Themas I6: Digitale Inventur- und Verleihliste. Das Projekt wurde im Wintersemester 2022 von 
betreut. Der Projektbericht entstand als Gruppenarbeit
