...
- Wir sind von der Verfügbarkeit des Servers und von der Datenbank abhängig.
...
. Wir nutzen ReactJS, HTML, TypeScript und CSS beim Frontend (User-Interface)
...
<<../belegabgabe_se2/JavaDoc_Backend/index.html,Code>>